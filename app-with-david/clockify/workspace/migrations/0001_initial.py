# Generated by Django 4.1.4 on 2023-01-01 23:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "permissions",
                    models.ManyToManyField(
                        related_name="roles", to="workspace.permission"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.CharField(max_length=255)),
                ("description", models.TextField()),
                ("max_allocated_hours", models.FloatField(blank=True, null=True)),
                (
                    "project",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "role",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="workspace.role"
                    ),
                ),
                (
                    "user",
